        ...
        div {
            ...
            // 中央互动剧情主视区
                ...
                div {
                    ...
                    div { class: "sticky bottom-0 z-20 flex w-[80%] self-center flex-col gap-2 rounded-2xl border border-purple-500/20 bg-zinc-950 p-3 shadow-inner backdrop-blur-xl",
