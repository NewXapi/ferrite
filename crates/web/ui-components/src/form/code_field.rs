        ...
        label { class: "block space-y-1.5",
            ...
            div { class: "flex gap-2",
                ...
                button {
                    ...
                    class: "shrink-0 rounded-lg border border-zinc-700 bg-zinc-800/50 px-4 py-2.5 {crate::TYPE_DESC} text-zinc-300 transition-all hover:border-zinc-500 hover:bg-zinc-800 hover:text-zinc-100 active:scale-95",
                    r#type: "button",
