...
pub fn ChoiceCard(
    ...
    rsx! {
        div { class: "flex flex-col overflow-hidden rounded-2xl border border-purple-500/40 bg-card/90 shadow-xl shadow-purple-950/20",
                ...
                for opt in options {
                    {
                        ...
                        rsx! {
                            button {
                                ...
                                span { class: "flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-purple-900/60 {crate::TYPE_DESC} text-purple-300 group-hover:bg-purple-600 group-hover:text-foreground transition-colors",
                                    "{opt_key}"
                                }
                                span { class: "{crate::TYPE_DESC} leading-5 group-hover:text-foreground transition-colors",
                                    "{opt.text}"
                                }
                            }
                        }
