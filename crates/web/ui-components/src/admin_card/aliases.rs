...
fn ratio_tone(ratio: f64) -> &'static str {
    if (ratio - 1.0).abs() < 0.001 {
        ...
        "border-emerald-800/60 bg-success text-success-foreground"
    } else {
        "border-amber-800/60 bg-warning text-warning-foreground"
    }
}
...
pub fn AliasCard(
        ...
        div { class: "space-y-2.5",
            if on_edit.is_some() {
                ...
                div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
                    ...
                    span { class: "font-medium text-foreground", "{title_alias}" }
                }
            }
            if on_edit.is_some() {
                EditableRow {
                ...
                div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
                    ...
                    span { class: "font-medium text-foreground", if display.is_empty() { "未填写" } else { "{display}" } }
                }
            }
            div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
                span { class: "{crate::C_MUTED}", "序号" }
                span { class: "font-medium text-foreground", "#{index + 1}" }
            }
            div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
        ...
        div { class: "space-y-2",
            ...
            if on_edit.is_some() {
                ...
                div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
                    ...
                    span { class: "font-medium text-foreground", "{fmt_price(input_per_1k)} / 1k tokens" }
                }
            }
            if on_edit.is_some() {
                EditableRow {
                ...
                div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
                    ...
                    span { class: "font-medium text-foreground", "{fmt_price(output_per_1k)} / 1k tokens" }
                }
            }
            if on_edit.is_some() {
                EditableRow {
                ...
                div { class: "flex justify-between gap-2 {crate::TYPE_DESC}",
                    ...
                    span { class: "font-medium text-foreground", "×{multiplier}" }
                }
            }
        }
    };
    ...
    let index_badge = rsx! {
        span {
            class: "shrink-0 rounded bg-secondary px-1.5 py-0.5 text-[10px] font-mono text-muted-foreground border border-border/60",
            "#{index + 1}"
        }
    };
