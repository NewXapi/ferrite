    ...
    rsx! {
        div { class: "rounded-xl border {ui::T_border_zinc_800} bg-zinc-900/60 p-6 transition-colors hover:{ui::T_border_zinc_600}",
            ...
            div { class: "grid grid-cols-1 gap-4 sm:grid-cols-2",
                div {
                    label { class: "mb-1.5 block {ui::T_text_xs} {ui::T_text_zinc_400}", "显示名" }
                    input {
                        class: "{ui::INPUT}",
            ...
            div { class: "mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2",
                div {
                    label { class: "mb-1.5 block {ui::T_text_xs} {ui::T_text_zinc_400}", "原密码" }
                    input {
                        class: "{ui::INPUT_MONO}",
                        r#type: "password",
                ...
                div {
                    label { class: "mb-1.5 block {ui::T_text_xs} {ui::T_text_zinc_400}", "新密码" }
                    input {
                        class: "{ui::INPUT_MONO}",
                        r#type: "password",
            ...
            if !save_err().is_empty() {
                p { class: "mt-3 {ui::T_text_xs} {ui::STATE_DANGER_TEXT}", "操作失败: {save_err()}" }
            }
        }
    }
}
