...
use super::shared::{
    ...
    MSG_LOAD_USERS_FAIL, MSG_LOADING, MSG_LOADING_USERS, MSG_MANAGE_ERR, MSG_MANAGED, MSG_MANAGING,
    MSG_NO_MATCH, MSG_SEARCH_HINT, MSG_USER_CREATED, OPT_ALL, SEC_FILTER, SEC_LIST, SEC_STATS,
};
