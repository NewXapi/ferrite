    ...
    rsx! {
        section {
            ...
            div { class: "flex items-center justify-between mb-4",
                h2 { class: "{ui::T_text_lg} {ui::T_font_semibold} {ui::T_text_zinc_100}", {LBL_PROXY_NODES} }
            }

            // 订阅导入
            div { class: "space-y-4 border-b {ui::T_border_zinc_800} pb-6",
                h3 { class: "{ui::T_text_sm} {ui::T_font_medium} {ui::T_text_zinc_300}", {FIELD_SUB_IMPORT} }
                div { class: "space-y-3",
                    input {
                        class: "w-full {ui::T_bg_zinc_950} border {ui::T_border_zinc_700} rounded-xl px-4 py-3 {ui::T_text_sm} {ui::T_text_zinc_100} placeholder-zinc-500 focus:outline-none focus:border-blue-500",
                    ...
                    button {
                        class: "w-full px-6 py-3 bg-blue-600 hover:bg-blue-500 disabled:{ui::T_bg_zinc_600} rounded-xl {ui::T_text_white} {ui::T_text_sm} {ui::T_font_medium} transition-colors",
            ...
            // 粘贴分享链接
            div { class: "space-y-4",
                h3 { class: "{ui::T_text_sm} {ui::T_font_medium} {ui::T_text_zinc_300}", {FIELD_SHARE_IMPORT} }
                textarea {
                    class: "w-full h-32 {ui::T_bg_zinc_950} border {ui::T_border_zinc_700} rounded-xl px-4 py-3 {ui::T_text_sm} {ui::T_text_zinc_100} placeholder-zinc-500 focus:outline-none focus:border-blue-500 font-mono resize-y",
                    placeholder: "vless://...\nvmess://...\nss://...",
                    value: share_text(),
                ...
                div { class: "grid grid-cols-2 gap-3",
                    input {
                        class: "{ui::T_bg_zinc_950} border {ui::T_border_zinc_700} rounded-xl px-4 py-3 {ui::T_text_sm} {ui::T_text_zinc_100} placeholder-zinc-500 focus:outline-none focus:border-blue-500",
                        placeholder: FIELD_CHANNELS_PLACEHOLDER,
                        value: channels_str(),
                        oninput: move |e| channels_str.set(e.value()),
                    }
            ...
            if let Some(e) = err_msg() {
                ...
                div {
                    ...
                    div { class: "flex gap-6 {ui::T_text_sm} mb-4",
                        span { class: "{ui::STATE_SUCCESS_TEXT} {ui::T_font_medium}", {MSG_CREATED_PREFIX} "{r.created}" }
                        span { class: "{ui::STATE_WARNING_TEXT} {ui::T_font_medium}", {MSG_SKIPPED_PREFIX} "{r.skipped}" }
                    }
                    if !r.failures.is_empty() {
                        div { class: "mt-3 pt-3 border-t {ui::T_border_zinc_700}",
                            p { class: "{ui::T_text_xs} {ui::T_text_zinc_400} mb-3", {MSG_FAILURES_TITLE} }
                            for f in &r.failures {
                                div {
                                    class: "mb-2 {ui::T_text_xs} p-3 {ui::T_bg_zinc_950} rounded border-l-4 {ui::STATE_DANGER_BORDER}",
                                    "data-testid": "proxy-import-failure",
                                    span { class: "font-mono {ui::STATE_DANGER_TEXT}", "{f.source}" }
                                    span { class: "{ui::T_text_zinc_500} mx-2", "→" }
                                    span { class: "{ui::T_text_zinc_300}", "{f.reason}" }
                                }
                            }
                        }
                    } else {
                        p { class: "{ui::T_text_xs} text-emerald-400/80", {MSG_ALL_IMPORTED} }
                    }
                }
            }
        }
