...
/// `role="search"`、`aria-label=LBL_FILTER_ARIA`;标题 `{ui::TYPE_CARD_TITLE}`
/// 旁挂 `{ui::TYPE_DESC}` 说明;「生成兑换码」为白底 `bg-white text-zinc-900` 主按钮;
        ...
        section {
            ...
            div { class: "flex items-center justify-between gap-3",
                div { class: "flex items-center gap-2",
                    ...
                    span { class: "{ui::TYPE_DESC}", "{SEC_FILTER_NOTE_REDEMPTIONS}" }
                }
                button {
