            ...
            div { class: "relative min-h-0 flex-1",
                ...
                div { class: "pointer-events-none absolute left-3 top-3 z-10 flex flex-wrap items-center gap-2",
                    for (i, g) in view_now.groups.iter().enumerate() {
                        span { class: "pointer-events-auto inline-flex items-center gap-1.5 rounded-full border border-zinc-800 bg-zinc-900/85 px-2.5 py-1 {ui::TYPE_DESC} backdrop-blur",
                ...
                // 右上：设置/导入/适配；抽屉开着时向右让出 320px
                {
                    ...
                    button {
                        class: "rounded-md border border-zinc-800 bg-zinc-900/85 px-2.5 py-1 {ui::TYPE_DESC} backdrop-blur hover:border-zinc-600 hover:text-zinc-200",
