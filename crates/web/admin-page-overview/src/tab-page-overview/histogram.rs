        ...
        div {
            ...
            div { class: "relative",
                div { class: "pointer-events-none absolute inset-0 flex flex-col justify-between py-0", aria_hidden: "true",
                    ...
                    for i in [4, 3, 2, 1] {
                        div { class: "relative w-full border-t border-dashed {ui::T_border_zinc_800}",
                            span { class: "absolute -top-2 right-0 {ui::T_text_10px} {ui::T_text_zinc_600}", "{fmt_raw((axis_max.max(1.0) * i as f64 / 4.0) as i64)}" }
                        }
                    }
                    div { class: "relative w-full border-t border-dashed {ui::T_border_zinc_800}",
                        span { class: "absolute -top-2 right-0 {ui::T_text_10px} {ui::T_text_zinc_600}", "0" }
                    }
                }
            ...
            div { class: "mt-2 flex {ui::T_text_10px} {ui::T_text_zinc_600}", style: "gap: 3px",
                for b in buckets.iter() {
