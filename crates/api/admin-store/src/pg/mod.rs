...
impl ChannelStore for PostgresStore {
    async fn put_channel(
        &self,
        _record: &contract::records::ChannelRecord,
    ...
    async fn get_channel(
        &self,
        _key: &str,
    ) -> Result<contract::records::ChannelRecord, StoreError> {
...
impl GroupStore for PostgresStore {
    async fn put_group(
        &self,
        _record: &contract::records::GroupRecord,
    ) -> Result<contract::mutations::MutationId, StoreError> {
        todo!("TODO(#410)")
    }
...
impl RouteUnitStore for PostgresStore {
    async fn put_route_unit(
        &self,
        _record: &contract::records::RouteUnitRecord,
    ) -> Result<contract::mutations::MutationId, StoreError> {
        todo!("TODO(#410)")
    }
    async fn get_route_unit(
        &self,
        _key: &str,
    ) -> Result<contract::records::RouteUnitRecord, StoreError> {
        todo!("TODO(#410)")
    }
    async fn delete_route_unit(
        &self,
        _key: &str,
    ) -> Result<contract::mutations::MutationId, StoreError> {
        todo!("TODO(#410)")
...
impl UserStore for PostgresStore {
    async fn put_user(
        &self,
        _record: &contract::records::UserRecord,
    ) -> Result<contract::mutations::MutationId, StoreError> {
        todo!("TODO(#410)")
    }
...
impl TokenStore for PostgresStore {
    async fn put_token(
        &self,
        _record: &contract::records::TokenRecord,
    ) -> Result<contract::mutations::MutationId, StoreError> {
        todo!("TODO(#410)")
    }
