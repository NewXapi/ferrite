...
fn TrendTooltipContainer(x: f64, y: f64, label: String, children: Element) -> Element {
    ...
    rsx! {
        div {
            class: "pointer-events-none fixed z-50 min-w-[220px] whitespace-nowrap rounded-xl border border-zinc-700/50 bg-zinc-900/95 p-4 text-xs shadow-2xl backdrop-blur-md",
