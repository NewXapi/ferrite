...
pub async fn rollup_window(_cutoff: chrono::DateTime<chrono::Utc>) -> Result<chrono::DateTime<chrono::Utc>, StoreError> {
    todo!("TODO(#700)")
}

/// 面板查询: 用户/管理员的用量曲线 (带 Freshness)。
/// TODO(#700): 时间范围聚合查询 + 分组维度选择。
pub async fn query(_query: &contract::api::usage::UsageLogQuery) -> Result<serde_json::Value, StoreError> {
    todo!("TODO(#700)")
}
